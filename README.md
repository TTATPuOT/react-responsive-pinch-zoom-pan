Fork of [react-responsive-pinch-zoom-pan](https://github.com/bradstiff/react-responsive-pinch-zoom-pan)

Added just one time double-tap zoom, second try will reset zoom.
---
